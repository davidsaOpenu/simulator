...
typedef struct ssd_config {
	...
	/* Per-namespace storage strategy: 1 = sector, 2 = object.
	 * Populated from STORAGE_STRATEGY inside [nsXX] sections in ssd.conf.
	 * 0 means "not set" — GET_NS_STORAGE_STRATEGY() defaults to sector. */
