...
//modified the lba format to "3" so the ms field is not zero but 128 
// (one can write 128 bytes of metadata) -> this also affects the nvme
// block size. 3 -> 512bytes
...
enum {
	...
	NVME_ADM_CMD_CREATE_OBJECT = 0x90,
    NVME_ADM_CMD_LAST,
};
