...
namespace {
    ...
    // first paramter in the pair is mb
    // second paramter in the pair is FLASH_NB
    std::vector<std::pair<size_t,size_t> > GetParams() {
        ...
        if (g_ci_mode) {
            ...
            list.push_back(std::make_pair(4,2));
            list.push_back(std::make_pair(8,2));

            list.push_back(std::make_pair(1,4));
            list.push_back(std::make_pair(2,4));
            list.push_back(std::make_pair(4,4));
            list.push_back(std::make_pair(8,4));

            list.push_back(std::make_pair(1,8));
            list.push_back(std::make_pair(2,8));
            list.push_back(std::make_pair(4,8));
            list.push_back(std::make_pair(8,8));

            list.push_back(std::make_pair(1,16));
            list.push_back(std::make_pair(2,16));
            list.push_back(std::make_pair(4,16));
            list.push_back(std::make_pair(8,16));

            list.push_back(std::make_pair(1,32));
            list.push_back(std::make_pair(2,32));
            list.push_back(std::make_pair(4,32));
            list.push_back(std::make_pair(8,32));

            return list;
        }

        list.push_back(std::make_pair(256,4));
        return list;
    }
