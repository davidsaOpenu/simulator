...
namespace write_read_test
{
    ...
    TEST_P(WriteReadTest, WRITEOnlyTest)
    {
        ...
        ASSERT_EQ(ssd_config->get_pages_ns(ID_SECTOR_NS0) + ssd_config->get_pages_ns(ID_SECTOR_NS1), log_server.stats[g_device_index].write_count);
    ...
    TEST_P(WriteReadTest, ReadAfterWriteTest)
    {
        ...
        ASSERT_EQ(ssd_config->get_pages_ns(ID_SECTOR_NS0) + ssd_config->get_pages_ns(ID_SECTOR_NS1), log_server.stats[g_device_index].read_count);
        ASSERT_EQ(ssd_config->get_pages_ns(ID_SECTOR_NS0) + ssd_config->get_pages_ns(ID_SECTOR_NS1), log_server.stats[g_device_index].write_count);
        ASSERT_EQ(1, log_server.stats[g_device_index].write_amplification);
        ASSERT_EQ(0.8, log_server.stats[g_device_index].utilization);
        ASSERT_EQ(0, log_server.stats[g_device_index].garbage_collection_count);
    ...
    TEST_P(WriteReadTest, WRITEREADWRITETest)
    {
        ...
        EXPECT_EQ(ssd_config->get_pages_ns(ID_SECTOR_NS0) + ssd_config->get_pages_ns(ID_SECTOR_NS1), log_server.stats[g_device_index].read_count);
        EXPECT_EQ(ssd_config->get_pages_ns(ID_SECTOR_NS0) + ssd_config->get_pages_ns(ID_SECTOR_NS1), log_server.stats[g_device_index].write_count);
