...
namespace {
    ...
    public:
        SSDConf(size_t size_mb, size_t sector_size = 1, int map_manager_threads = 1) {
            ...
            this->map_manager_threads = map_manager_threads;
        }

        SSDConf(size_t page_size, size_t page_nb, size_t sector_size,
                size_t flash_nb, size_t block_nb, size_t channel_nb, int map_manager_threads = 1)
                : page_size(page_size), page_nb(page_nb), sector_size(sector_size),
                  flash_nb(flash_nb), block_nb(block_nb), channel_nb(channel_nb), map_manager_threads(map_manager_threads) {
        ...
        int get_map_manager_threads() {
            return this->map_manager_threads;
        }
        ...
        void ssd_conf_serialize(void) {
            ...
            ssd_conf << "[nvme01]\n"
                ...
                "GC_LOW_THR 20\n"
                "GC_HI_THR 80\n"
                "MAP_MANAGER_THREADS " << get_map_manager_threads() << "\n"
                "[nvme02]\n"
