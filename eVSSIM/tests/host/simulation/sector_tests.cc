...
namespace sector_tests {
    ...
    TEST_P(SectorUnitTest, WriteBeyondNamespaceBoundary) {
        ...
        ASSERT_EQ(FTL_SUCCESS, FTL_WRITE_SECT(g_device_index, DEFAULT_NSID, (ssd_config->get_pages_ns(DEFAULT_NSID) - 1) * ssd_config->get_page_size(), 1, NULL));
        ...
        ASSERT_EQ(FTL_SUCCESS, FTL_WRITE_SECT(g_device_index, OTHER_NSID, (ssd_config->get_pages_ns(OTHER_NSID)  - 1) * ssd_config->get_page_size(), 1, NULL));
    ...
    TEST_P(SectorUnitTest, ReadBeyondNamespaceBoundary) {
        ...
        ASSERT_EQ(FTL_SUCCESS, FTL_READ_SECT(g_device_index, DEFAULT_NSID, (ssd_config->get_pages_ns(DEFAULT_NSID) - 1) * ssd_config->get_page_size(), 1, NULL));
        ...
        ASSERT_EQ(FTL_SUCCESS, FTL_READ_SECT(g_device_index, OTHER_NSID, (ssd_config->get_pages_ns(OTHER_NSID)  - 1) * ssd_config->get_page_size(), 1, NULL));
    ...
    TEST_P(SectorUnitTest, WriteNSToFull) {
        ...
        ASSERT_EQ(FTL_FAILURE, FTL_WRITE_SECT(g_device_index, DEFAULT_NSID, ssd_config->get_pages_ns(OTHER_NSID) * ssd_config->get_page_size(), 1, NULL));
        ASSERT_EQ(FTL_FAILURE, FTL_WRITE_SECT(g_device_index, OTHER_NSID, ssd_config->get_pages_ns(OTHER_NSID) * ssd_config->get_page_size(), 1, NULL));
        ...
        for(int x=0; x<2 /*8*/; x++){
            ...
            for(size_t p=0; (p < ssd_config->get_pages_ns(OTHER_NSID)); p++){
                ASSERT_EQ(FTL_SUCCESS, FTL_WRITE_SECT(g_device_index, OTHER_NSID, p * ssd_config->get_page_size(), 1, NULL));
            }
            for(size_t p=0; (p < ssd_config->get_pages_ns(DEFAULT_NSID)); p++){
                ASSERT_EQ(FTL_SUCCESS, FTL_READ_SECT(g_device_index, DEFAULT_NSID, p * ssd_config->get_page_size(), 1, NULL));
            ...
            for(size_t p=0; (p < ssd_config->get_pages_ns(OTHER_NSID)); p++){
                ASSERT_EQ(FTL_SUCCESS, FTL_READ_SECT(g_device_index, OTHER_NSID, p * ssd_config->get_page_size(), 1, NULL));
            }
        }
