...
namespace rt_subscriber {
    ...
    SSDStatistics results[] = {
            ...
            // physical cell read
            {
                    ...
                    .logical_write_count = 0,
                    .write_elapsed_time = 0,
                    .read_elapsed_time = (REG_READ_DELAY + CELL_READ_DELAY),
                    .log_id = 0,
                    .block_erase_count = 0,
                    .channel_switch_to_write = 0,
                    .channel_switch_to_read = 0
            ...
            // physical cell program
            {
                    ...
                    .logical_write_count = 0,
                    .write_elapsed_time = (CHANNEL_SWITCH_DELAY_W + CELL_PROGRAM_DELAY),
                    .read_elapsed_time = (REG_READ_DELAY + CELL_READ_DELAY),
                    .log_id = 0,
                    .block_erase_count = 0,
                    .channel_switch_to_write = 1,
            ...
            // physical cell program
            {
                    ...
                    .logical_write_count = 1,
                    .write_elapsed_time = (CHANNEL_SWITCH_DELAY_W + CELL_PROGRAM_DELAY + REG_WRITE_DELAY + CELL_PROGRAM_DELAY),
                    .read_elapsed_time = (REG_READ_DELAY + CELL_READ_DELAY),
                    .log_id = 0,
                    .block_erase_count = 0,
                    .channel_switch_to_write = 1,
            ...
            // physical cell read
            {
                    ...
                    .logical_write_count = 2,
                    .write_elapsed_time = (CHANNEL_SWITCH_DELAY_W + CELL_PROGRAM_DELAY + REG_WRITE_DELAY + CELL_PROGRAM_DELAY),
                    .read_elapsed_time = (REG_READ_DELAY + CELL_READ_DELAY + BLOCK_ERASE_DELAY + CHANNEL_SWITCH_DELAY_R + CELL_READ_DELAY),
                    .log_id = 0,
                    .block_erase_count = 1,
                    .channel_switch_to_write = 1,
                    .channel_switch_to_read = 1
    ...
    void write() {
        ...
        LOG_LOGICAL_CELL_PROGRAM(logger, (LogicalCellProgramLog) {
            ...
            .metadata = LOG_META(g_device_index, start, end5)
        });
        TIME_MICROSEC(end6);
    ...
    void analyze_stats(SSDStatistics stats, void*) {
        ...
        ASSERT_EQ(res.write_elapsed_time, stats.write_elapsed_time);
        ASSERT_EQ(res.read_elapsed_time, stats.read_elapsed_time);
    }
