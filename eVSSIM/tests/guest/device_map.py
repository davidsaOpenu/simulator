...
DEVICE_MAP = {
    # Controller 0 (serial=1) = nvme01: 2 namespaces
    "/dev/nvme0n1": {"ctrl": 0, "nsid": 1, "device": "nvme01", "ns": "ns01",
                     "strategy": SECTOR, "desc": "nvme01 ns01 - Sector"},
    "/dev/nvme0n2": {"ctrl": 0, "nsid": 2, "device": "nvme01", "ns": "ns02",
                     "strategy": OBJECT, "desc": "nvme01 ns02 - Object"},
...
EXPECTED_DEVICE_COUNT = len(DEVICE_MAP)  # 15
