...
uint64_t* current_id = NULL;

#define OBJECTS_TABLE(device_index) (objects_table[device_index])
#define OBJECTS_MAPPING(device_index) (objects_mapping[device_index])
#define GLOBAL_PAGE_TABLE(device_index) (global_page_table[device_index])
#define CURRENT_ID(device_index) (current_id[device_index])
#define OSD_DEVICE(device_index) (&osd)
#define OSD_SENSE(device_index) (osd_sense)
