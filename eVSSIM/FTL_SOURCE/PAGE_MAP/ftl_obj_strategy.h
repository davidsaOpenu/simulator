...
/* FTL functions */
ftl_ret_val _FTL_OBJ_READ(unique_object_id *object_loc, uint8_t *buf, unsigned int offset, unsigned int length);
ftl_ret_val _FTL_OBJ_WRITE(unique_object_id *object_loc, uint8_t *buf, unsigned int offset, unsigned int length);
