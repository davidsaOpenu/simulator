    ...
    while (max_logs < 0 || logs_read < max_logs) {
        ...
        switch (log_type) {
            case PHYSICAL_CELL_READ_LOG_UID:
            {
                ...
                NEXT_PHYSICAL_CELL_READ_LOG(analyzer->logger, &res, 1);
                stats.read_count++;
            ...
            case PHYSICAL_CELL_PROGRAM_LOG_UID:
            {
                ...
                NEXT_PHYSICAL_CELL_PROGRAM_LOG(analyzer->logger, &res, 1);
                stats.write_count++;
            ...
            case LOGICAL_CELL_PROGRAM_LOG_UID:
            {
                ...
                NEXT_LOGICAL_CELL_PROGRAM_LOG(analyzer->logger, &res, 1);
            ...
            case GARBAGE_COLLECTION_LOG_UID:
            {
                ...
                NEXT_GARBAGE_COLLECTION_LOG(analyzer->logger, &res, 1);
            ...
            {
                RegisterReadLog res;
                NEXT_REGISTER_READ_LOG(analyzer->logger, &res, 1);
            ...
            case REGISTER_WRITE_LOG_UID:
            {
                ...
                NEXT_REGISTER_WRITE_LOG(analyzer->logger, &res, 1);
            ...
            {
                BlockEraseLog res;
                NEXT_BLOCK_ERASE_LOG(analyzer->logger, &res, 1);
            ...
            case CHANNEL_SWITCH_TO_READ_LOG_UID:
            {
                ...
                NEXT_CHANNEL_SWITCH_TO_READ_LOG(analyzer->logger, &res, 1);
            ...
            case CHANNEL_SWITCH_TO_WRITE_LOG_UID:
            {
                ...
                NEXT_CHANNEL_SWITCH_TO_WRITE_LOG(analyzer->logger, &res, 1);
