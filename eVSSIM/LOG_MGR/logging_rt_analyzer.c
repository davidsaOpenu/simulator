...
void rt_log_stats_init(void) {
    rt_log_stats = (RTLogStatistics*) malloc(sizeof(RTLogStatistics) * devices[current_device_index].flash_nb);
    ...
    while (max_logs < 0 || logs_read < max_logs) {
        ...
        switch (log_type) {
            case PHYSICAL_CELL_READ_LOG_UID:
            {
                ...
                stats.read_count++;
                rt_log_stats[analyzer->rt_analyzer_id].current_wall_time += devices[current_device_index].cell_read_delay;
            ...
            case PHYSICAL_CELL_PROGRAM_LOG_UID:
            {
                ...
                rt_log_stats[analyzer->rt_analyzer_id].current_wall_time += devices[current_device_index].cell_program_delay;
            ...
            case REGISTER_READ_LOG_UID:
            {
                ...
                rt_log_stats[analyzer->rt_analyzer_id].current_wall_time += devices[current_device_index].reg_read_delay;
                break;
            }
            case REGISTER_WRITE_LOG_UID:
            {
                ...
                rt_log_stats[analyzer->rt_analyzer_id].current_wall_time += devices[current_device_index].reg_write_delay;
                break;
            }
            case BLOCK_ERASE_LOG_UID:
            {
                ...
                rt_log_stats[analyzer->rt_analyzer_id].current_wall_time += devices[current_device_index].block_erase_delay;
            ...
            case CHANNEL_SWITCH_TO_READ_LOG_UID:
            {
                ...
                rt_log_stats[analyzer->rt_analyzer_id].current_wall_time += devices[current_device_index].channel_switch_delay_r;
            ...
            case CHANNEL_SWITCH_TO_WRITE_LOG_UID:
            {
                ...
                rt_log_stats[analyzer->rt_analyzer_id].current_wall_time += devices[current_device_index].channel_switch_delay_w;
