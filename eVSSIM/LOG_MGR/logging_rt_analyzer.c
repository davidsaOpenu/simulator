    ...
    while (max_logs < 0 || logs_read < max_logs) {
        ...
        switch (log_type) {
            ...
            case PHYSICAL_CELL_PROGRAM_LOG_UID:
                ...
                stats.write_count++;
                rt_log_blocks[pcpl.die * BLOCK_NB + pcpl.block].written_pages++;
            ...
            case BLOCK_ERASE_LOG_UID:
                ...
                int op = rt_log_blocks[pcpl.die * BLOCK_NB + pcpl.block].written_pages;
                rt_log_stats.occupied_pages -= op;
                rt_log_blocks[pcpl.die * BLOCK_NB + pcpl.block].written_pages = 0;
