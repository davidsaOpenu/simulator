...
typedef struct {
	...
	/**
	 * Timestamp of last write to the logger node
	 */
...
typedef struct {
	 ...
	 */
	unsigned int number_of_allocated_nodes;
	/**
 * Total number of nodes in the Logger Pool
 */
unsigned int total_number_of_nodes;
} Logger_Pool;
