...
evssim_run_at_folder "$EVSSIM_SIMULATOR_FOLDER/eVSSIM/open-osd" "git apply ../../infra/builder/open-osd-compilaiton-errors.patch"
...
evssim_run_at_folder "$EVSSIM_SIMULATOR_FOLDER/eVSSIM/scripts" "cp open-osd-compilaiton-errors.patch.sh \
