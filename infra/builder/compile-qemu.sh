...
# Copy the exofs and ext4 setup scripts into the dist directory
evssim_run_at_folder "$version" "$EVSSIM_SIMULATOR_FOLDER/eVSSIM/scripts" "cp -r exofs ext4 \
    $EVSSIM_DOCKER_ROOT_PATH/$EVSSIM_DIST_FOLDER/"
