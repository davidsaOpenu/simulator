...
# Calculate sizes for nvme devices only
...
# Wait for the QEMU guest VM to become reachable over SSH.
# Polls every 5 seconds until SSH accepts a connection, up to 5 minutes.
# Parameters - None
