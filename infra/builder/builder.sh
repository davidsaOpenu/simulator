...
# Ensure important paths
chmod 600 $EVSSIM_ROOT_PATH/$EVSSIM_BUILDER_FOLDER/docker/id_rsa
if [ ! -L $EVSSIM_ROOT_PATH/$EVSSIM_SIMULATOR_FOLDER/eVSSIM/tests/host/data ]; then
    ln -rs $EVSSIM_ROOT_PATH/$EVSSIM_DATA_FOLDER $EVSSIM_ROOT_PATH/$EVSSIM_SIMULATOR_FOLDER/eVSSIM/tests/host/data
fi
