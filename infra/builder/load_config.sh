...
load_config() {
    ...
    load_config_section "GUEST_TESTS" "$cfg_query | .guestTests" "$config_file" "guestVmImage" "guestVmBuildContainer" "compileContainer" || return 1
    ...
    echo "  VM Image Build Container: $EVSSIM_GUEST_TESTS_GUEST_VM_BUILD_CONTAINER"
    echo "=========================================="
