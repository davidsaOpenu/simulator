...
load_config() {
    ...
    load_config_section "GUEST_TESTS" "$cfg_query | .guestTests" "$config_file" "runContainer" "compileContainer" || return 1
    ...
    echo "  Host Container: $EVSSIM_GUEST_TESTS_RUN_CONTAINER"
