...
evssim_run_at_folder $EVSSIM_KERNEL_FOLDER "make -j\`nproc\`"
evssim_run_at_folder $EVSSIM_KERNEL_FOLDER "make modules -j\`nproc\`"
evssim_run_at_folder $EVSSIM_KERNEL_FOLDER "make INSTALL_PATH=$install_path INSTALL_MOD_PATH=$install_path modules_install install"
