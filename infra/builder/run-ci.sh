...
# TODO: ELK host/simulator performance test skipped for namespace PR per David's review:
# "namespace support is only relevant in QEMU, not in the simulator. No need to run host tests."
