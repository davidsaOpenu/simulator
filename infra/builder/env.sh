...
export EVSSIM_NVME_COMPLIANCE_FOLDER=nvmeCompl-master
...
export EVSSIM_QEMU_IMAGE_SIZE=1g
...
export EVSSIM_QEMU_FOLDER=$EVSSIM_SIMULATOR_FOLDER/eVSSIM/QEMUv2.12
export EVSSIM_QEMU_PORT=2222
export EVSSIM_QEMU_TRACE_NVME=yes
export EVSSIM_QEMU_VNC=0

export EVSSIM_DOCKER_ROOT_PATH=/code
export EVSSIM_DOCKER_IMAGE_NAME=evssim
export EVSSIM_DOCKER_MAX_TIMEOUT_IN_MINUTES=60
...
export EVSSIM_RUNTIME_ALWAYS_RESET=no
...
export EVSSIM_DATA_LINKED_FOLDER="eVSSIM/QEMU/hw/data eVSSIM/tests/host/data"
