...
#   EVSSIM_GUEST_TESTS_HOST_CONTAINER
...
export EVSSIM_CONTAINERS_FOLDER=$EVSSIM_VERSIONS_FOLDER/containers
export EVSSIM_KERNEL_FOLDER=kernel
export EVSSIM_KERNEL_MAKE_ARGS="CONFIG_BLK_DEV_NVME=m"
export EVSSIM_KERNEL_DIST="$EVSSIM_KERNEL_BRANCH"
export EVSSIM_VERSIONS_KERNEL_FOLDER=$EVSSIM_VERSIONS_FOLDER/kernel
