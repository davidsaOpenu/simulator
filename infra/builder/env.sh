...
export ELK_ELASTICSEARCH_IMAGE="docker.elastic.co/elasticsearch/elasticsearch:8.2.3"
export ELK_KIBANA_IMAGE="docker.elastic.co/kibana/kibana:8.2.3"
export ELK_FILEBEAT_IMAGE="docker.elastic.co/beats/filebeat:8.2.3"
