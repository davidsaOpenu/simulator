...
MIN_READ_COUNT="${MIN_READ_COUNT:-100000}"
MIN_WRITE_COUNT="${MIN_WRITE_COUNT:-100000}"
MIN_LOGICAL_WRITE_COUNT="${MIN_LOGICAL_WRITE_COUNT:-100000}"

REQUIRE_UTILIZATION="${REQUIRE_UTILIZATION:-1}"

GC_FOREGROUND_TRIGGER="${GC_FOREGROUND_TRIGGER:-1}"
MIN_UTIL_AT_FG_GC="${MIN_UTIL_AT_FG_GC:-0.05}"
